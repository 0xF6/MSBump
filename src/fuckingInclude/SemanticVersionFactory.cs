namespace Ivy.Versioning
{
    ...
    public partial class SemanticVersion
    {
        ...
        public static SemanticVersion Parse(string value)
        {
            ...
            {
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, "Invalidvalue", value), "value");
            }
        ...
        public static IEnumerable<string> ParseReleaseLabels(string releaseLabels)
        {
